    ...
    <>
            ...
            <form>
              <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-100">
                <div className="w-full pb-2 sm:pb-0">
                  ...
                  <input type="text" id="hs-hero-name-1" className="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 text-gray-800" placeholder="Your name" />
                </div>
                <div className="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s w-full">
                  ...
                  <input type="email" id="hs-hero-email-1" className="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 text-gray-800" placeholder="Your email address" />
                </div>
      ...
      <div className="bg-neutral-900 text-white">
        ...
        <header className="sticky top-4 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
          <nav className="relative max-w-[85rem] w-full bg-neutral-800/30 backdrop-blur-md rounded-full mx-2 py-2.5 ps-5 pe-2 md:flex md:items-center md:justify-between md:py-0 md:px-4 lg:mx-auto" aria-label="Global">
            <div className="flex items-center justify-between">
              {/* Logo */}
              <a className="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="#" aria-label="Brand">
                MySaaS
              </a>
              {/* End Logo */}
            ...
            <div id="navbar-collapse" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
              <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
                <a className="font-medium text-neutral-300 hover:text-white md:py-6" href="#" aria-current="page">Features</a>
                <a className="font-medium text-neutral-300 hover:text-white md:py-6" href="#">Pricing</a>
                <a className="font-medium text-neutral-300 hover:text-white md:py-6" href="#">Docs</a>

                <a className="flex items-center gap-x-2 font-medium text-neutral-300 hover:text-white md:border-s md:border-neutral-700 md:my-6 md:ps-6" href="#">
        ...
        <main id="content">
          ...
          <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
              {/* Card */}
              <div className="size-full bg-neutral-800 shadow-lg rounded-lg p-5">
                <div className="flex items-center gap-x-4 mb-3">
                  <div className="inline-flex justify-center items-center size-[62px] rounded-full border-4 border-blue-500/20 bg-blue-500/10 text-blue-500">
                  ...
                  <div className="flex-shrink-0">
                    <h3 className="block text-lg font-semibold text-gray-200">Easy Collaboration</h3>
                  </div>
                </div>
                <p className="text-gray-400">Work together seamlessly with shared workspaces and real-time updates.</p>
              </div>
              {/* End Card */}
              ...
              <div className="size-full bg-neutral-800 shadow-lg rounded-lg p-5">
                <div className="flex items-center gap-x-4 mb-3">
                  <div className="inline-flex justify-center items-center size-[62px] rounded-full border-4 border-violet-500/20 bg-violet-500/10 text-violet-500">
                    <svg className="flex-shrink-0 size-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                  </div>
                  <div className="flex-shrink-0">
                    <h3 className="block text-lg font-semibold text-gray-200">Automated Workflows</h3>
                  </div>
                </div>
                <p className="text-gray-400">Save time and reduce errors by automating repetitive tasks.</p>
              </div>
              {/* End Card */}
              ...
              <div className="size-full bg-neutral-800 shadow-lg rounded-lg p-5">
                <div className="flex items-center gap-x-4 mb-3">
                  <div className="inline-flex justify-center items-center size-[62px] rounded-full border-4 border-emerald-500/20 bg-emerald-500/10 text-emerald-500">
                    <svg className="flex-shrink-0 size-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                  </div>
                  <div className="flex-shrink-0">
                    <h3 className="block text-lg font-semibold text-gray-200">Powerful Analytics</h3>
                  </div>
                </div>
                <p className="text-gray-400">Gain valuable insights into your team's performance and project progress.</p>
              </div>
              {/* End Card */}
            </div>
            {/* End Grid */}
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="mt-3 text-lg text-neutral-400">
                    Join thousands of successful teams already using MySaaS.
                  </p>
                </div>
        ...
        <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
          ...
          <div className="text-center">
            <div>
              <a className="flex-none text-xl font-semibold text-white focus:outline-none focus:opacity-80" href="#" aria-label="Brand">MySaaS</a>
            </div>
            {/* End Col */}

            <div className="mt-3">
              <p className="text-gray-500">We're part of the <a className="font-semibold text-blue-600 hover:text-blue-700" href="#">Preline</a> family.</p>
              <p className="text-gray-500">© MySaaS. 2024 Preline. All rights reserved.</p>
            </div>
